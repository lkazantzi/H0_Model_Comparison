...
int background_w_fld(
  ...
  case CLP:
    ...
    *w_fld = -((pba->daSN*(-1. + (-1. + pba->atSN)/sqrt(pow(-1. + pba->atSN,2) + pow(pba->daSN,2)) + (1 - pba->atSN/sqrt(pow(pba->atSN,2) + pow(pba->daSN,2)))*(1. - pba->DeltawSN)))/(((-1. + pba->atSN)*pba->daSN)/sqrt(pow(-1. + pba->atSN,2) + pow(pba->daSN,2)) - (pba->atSN*pba->daSN)/sqrt(pow(pba->atSN,2) + pow(pba->daSN,2)))) + (sqrt(pow(-1. + pba->atSN,2) + pow(pba->daSN,2))*sqrt(pow(pba->atSN,2) + pow(pba->daSN,2))*(1. + (a - pba->atSN)/sqrt(pow(a - pba->atSN,2) + pow(pba->daSN,2)))*pba->DeltawSN)/(sqrt(pow(pba->atSN,2) + pow(pba->daSN,2)) + pba->atSN*(sqrt(pow(-1. + pba->atSN,2) + pow(pba->daSN,2)) - sqrt(pow(pba->atSN,2) + pow(pba->daSN,2))));
    break;
  case EDE:
  ...
  case CLP:
    ...
    *dw_over_da_fld = (sqrt(pow(-1 + pba->atSN,2) + pow(pba->daSN,2))*sqrt(pow(pba->atSN,2) + pow(pba->daSN,2))*(-(pow(a- pba->atSN,2)/pow(pow(a - pba->atSN,2) + pow(pba->daSN,2),1.5)) + 1/sqrt(pow(a - pba->atSN,2) + pow(pba->daSN,2)))*pba->DeltawSN)/(sqrt(pow(pba->atSN,2) +pow(pba->daSN,2)) + pba->atSN*(sqrt(pow(-1 + pba->atSN,2) +pow(pba->daSN,2)) - sqrt(pow(pba->atSN,2) + pow(pba->daSN,2))));
    break;
  case EDE:
  ...
  case CLP:
    ...
    *integral_fld = (3*sqrt(1 - 2*pba->atSN + pow(pba->atSN,2) + pow(pba->daSN,2))*pba->DeltawSN*(sqrt(pow(pba->atSN,2) + pow(pba->daSN,2))*log(a - pba->atSN + sqrt(pow(a - pba->atSN,2) + pow(pba->daSN,2))) - sqrt(pow(pba->atSN,2) + pow(pba->daSN,2))*log(1 - pba->atSN + sqrt(pow(-1 + pba->atSN,2) + pow(pba->daSN,2))) + pba->atSN*log(-(a*pba->atSN) + pow(pba->atSN,2) + pow(pba->daSN,2) + sqrt(pow(a - pba->atSN,2) + pow(pba->daSN,2))*sqrt(pow(pba->atSN,2) + pow(pba->daSN,2))) - pba->atSN*log((-1 + pba->atSN)*pba->atSN + pow(pba->daSN,2) + sqrt(pow(-1 + pba->atSN,2) + pow(pba->daSN,2))*sqrt(pow(pba->atSN,2) + pow(pba->daSN,2)))))/(-sqrt(pow(pba->atSN,2) + pow(pba->daSN,2)) + pba->atSN*sqrt(pow(pba->atSN,2) + pow(pba->daSN,2)) - pba->atSN*sqrt(1 - 2*pba->atSN + pow(pba->atSN,2) + pow(pba->daSN,2)));
    break;
  case EDE:
